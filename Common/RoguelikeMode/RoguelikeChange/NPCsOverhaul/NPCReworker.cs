...
namespace EverlastingOverhaul.Common.RoguelikeMode.RoguelikeChange.NPCsOverhaul;
...
public class NPCReworker : GlobalNPC {
	...
	public override void SendExtraAI(NPC npc, BitWriter bitWriter, BinaryWriter binaryWriter) {
		...
		binaryWriter.Write(Counter5);
		binaryWriter.Write(AIStateSync);
	}
	...
	public override void ReceiveExtraAI(NPC npc, BitReader bitReader, BinaryReader binaryReader) {
		...
		Counter5 = binaryReader.ReadInt32();
		AIStateSync = binaryReader.ReadInt32();
