	...
	public override bool PreDraw(ref Color lightColor) {
		...
		if (!player.ItemAnimationActive && Main.mouseRight) {
			...
			for (int i = 0; i < length; i++) {
				var currentPos = Vector2.Lerp(Projectile.Center, player.Center, i / length) - Main.screenPosition + new Vector2(0, Projectile.gfxOffY);
		...
		var drawpos = Projectile.position - Main.screenPosition + new Vector2(0, Projectile.gfxOffY);
