...
using static EverlastingOverhaul.Common.Utils.ModUtils;
...
namespace EverlastingOverhaul.Common.Utils
{
    public static partial class ModUtils
    {
        ...
        public static string LocalizationText(string text, string extra = null)
        {
            ...
            {
                return Language.GetTextValue($"Mods.EverlastingOverhaul.{Regex.Replace(text, @"\s+", "")}");
            }
            return Language.GetTextValue($"Mods.EverlastingOverhaul.{Regex.Replace(text, @"\s+", "")}.{Regex.Replace(extra, @"\s+", "")}");
        }
        //Taken from chatGPT
