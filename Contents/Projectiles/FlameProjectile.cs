...
namespace EverlastingOverhaul.Contents.Projectiles;
...
public class FlameProjectile : ModProjectile
{
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        target.AddBuff(DebuffType, ModUtils.ToSecond(4));
    }
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color color2 = ModUtils.FakeHueShift(color, 10);
        Color color3 = Color.Lerp(ModUtils.FakeHueShift(color, 20), color2, 0.25f);
