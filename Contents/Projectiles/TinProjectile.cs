...
namespace EverlastingOverhaul.Contents.Projectiles
{
	...
	class TinBarProjectile : ModProjectile {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.TinBar);
		public override void SetDefaults() {
			Projectile.width = Projectile.height = 16;
			Projectile.friendly = true;
			Projectile.timeLeft = 300;
	...
	class TinBroadSwordProjectile : ModProjectile {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.TinBroadsword);
		public override void SetDefaults() {
