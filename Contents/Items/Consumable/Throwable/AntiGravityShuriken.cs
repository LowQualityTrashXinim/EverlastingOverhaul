...
namespace EverlastingOverhaul.Contents.Items.Consumable.Throwable;
...
public class AntiGravityShurikenProjectile : ModProjectile {
	public override string Texture => ModUtils.GetTheSameTextureAsEntity<AntiGravityShuriken>();
