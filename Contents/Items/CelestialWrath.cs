	...
	internal class CelestialWrath : ModItem {
		...
		public override bool? UseItem(Player player) {
			if (player.ItemAnimationJustStarted)
				ModUtils.CombatTextRevamp(player.Hitbox, Color.Red, Language.GetTextValue("Mods.EverlastingOverhaul.Items.CelestialWrath.WarningMessage"));
			return true;
		}
	}
	class CelestialWrathProjectile : ModProjectile {
		public override string Texture => ModUtils.GetTheSameTextureAsEntity<CelestialWrath>();
		public override void SetStaticDefaults() {
		...
		public override void AI() {
			...
			float timer = MathHelper.Lerp(1, 120, ModUtils.InExpo((1200 - Projectile.timeLeft) / 1200f));
