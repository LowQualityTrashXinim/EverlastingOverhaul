...
namespace EverlastingOverhaul.Contents.Items.Accessories.EnragedBossAccessories.EvilEye
{
	class PhantasmalEye : ModProjectile {
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D texture = ModContent.Request<Texture2D>(ModUtils.GetTheSameTextureAs<PhantasmalEye>("PhantasmalEyeAfterImage")).Value;
