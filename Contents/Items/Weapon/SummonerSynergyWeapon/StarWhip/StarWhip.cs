...
namespace EverlastingOverhaul.Contents.Items.Weapon.SummonerSynergyWeapon.StarWhip;
...
public class StarWhipProj : ModProjectile {
	...
	public override bool PreDraw(ref Color lightColor) {
		...
		ModUtils.DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, list.ElementAt(list.Count - 2) - Main.screenPosition, Color.Yellow, Color.White, 0.1f, 0f, 0.1f, 0f, 0.25f, Projectile.rotation, new Vector2(4f, 4f), new Vector2(3f));
...
public class StarWhipTipTracker : ModProjectile {
	public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.AbigailMinion);
...
public class FallenStarPower : ModNPC {
	public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.StarCannonStar);
	public override void SetDefaults() {
		NPC.friendly = false;
		NPC.lifeMax = 1;
		NPC.damage = 0;
	...
	public override void ModifyHitByProjectile(Projectile projectile, ref NPC.HitModifiers modifiers) {
		...
		Main.player[projectile.owner].AddBuff(ModContent.BuffType<StarWhipBuff>(), ModUtils.ToSecond(5));
	...
	public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
		...
		ModUtils.DrawPrettyStarSparkle(NPC.Opacity, SpriteEffects.None, NPC.Center - Main.screenPosition, Color.Yellow, Color.White, 0.25f, 0f, 0.5f, 0f, 1f, NPC.rotation, new Vector2(1f, 1f), new Vector2(15f));
		return false;
	}
	...
	public override void AI() {
		...
		if (NPC.ai[1] >= ModUtils.ToSecond(10))
