...
namespace EverlastingOverhaul.Contents.Items.Weapon.MeleeSynergyWeapon.SuperShortSword
{
	public class SuperShortSwordP : ModProjectile {
		public override string Texture => ModUtils.GetTheSameTextureAsEntity<SuperShortSword>();
