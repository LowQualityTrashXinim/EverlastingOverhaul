...
namespace EverlastingOverhaul.Contents.Items.Weapon.MeleeSynergyWeapon.BurningPassion;
public class BurningPassion : SynergyModItem {
	...
	public override void HoldSynergyItem(Player player, PlayerSynergyItemHandle modplayer) {
		...
		player.GetModPlayer<BurningPassionPlayer>().BurningPassion_Cooldown = ModUtils.CountDown(player.GetModPlayer<BurningPassionPlayer>().BurningPassion_Cooldown);
	}
