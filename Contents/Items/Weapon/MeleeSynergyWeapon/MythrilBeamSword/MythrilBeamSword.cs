...
namespace EverlastingOverhaul.Contents.Items.Weapon.MeleeSynergyWeapon.MythrilBeamSword;
...
public class MythrilBeam : ModProjectile {
	...
	public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.SwordBeam);
	public override void SetDefaults() {
