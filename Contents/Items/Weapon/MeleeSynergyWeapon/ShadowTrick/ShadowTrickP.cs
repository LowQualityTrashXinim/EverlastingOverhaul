...
namespace EverlastingOverhaul.Contents.Items.Weapon.MeleeSynergyWeapon.ShadowTrick
{
	...
	internal class ShadowTrickP2 : ModProjectile {
		public override string Texture => ModUtils.GetTheSameTextureAsEntity<ShadowTrickP>();
		public override void SetStaticDefaults() {
