...
namespace EverlastingOverhaul.Contents.Items.Weapon.MeleeSynergyWeapon.EnchantedOreSword {
	...
	internal class EnchantedIronSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.IronShortsword);
		public override void SetStaticDefaults() {
	...
	internal class EnchantedLeadSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.LeadShortsword);
		public override void PostSetDefault() {
			Projectile.light = .55f;
		}
		int count = 0;
	...
	internal class EnchantedSilverSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.SilverShortsword);
		public override void PostSetDefault() {
	...
	internal class EnchantedTungstenSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.TungstenShortsword);
		public override void PostSetDefault() {
			Projectile.light = 0.65f;
		}
		int firstFrame = 0;
	...
	internal class EnchantedGoldSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.GoldShortsword);
		public override void PostSetDefault() {
	...
	internal class EnchantedPlatinumSwordP : EnchantedProjectileBase {
		public override string Texture => ModUtils.GetVanillaTexture<Item>(ItemID.PlatinumShortsword);
		public override void PostSetDefault() {
			Projectile.light = .75f;
