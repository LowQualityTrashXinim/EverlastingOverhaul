...
namespace EverlastingOverhaul.Contents.Items.Weapon.RangeSynergyWeapon.Bowmarang {
	internal class Bowmarang : SynergyModItem {
		...
		public override void ModifySynergyToolTips(ref List<TooltipLine> tooltips, PlayerSynergyItemHandle modplayer) {
			SynergyBonus_System.Write_SynergyTooltip(ref tooltips, this, ItemID.WoodYoyo);
		}
	...
	public class Bowmarang_WoodYoyo_Projectile : ModProjectile {
		public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.WoodYoyo);
