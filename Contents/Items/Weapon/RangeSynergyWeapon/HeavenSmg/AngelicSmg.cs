...
namespace EverlastingOverhaul.Contents.Items.Weapon.RangeSynergyWeapon.HeavenSmg {
	...
	public class AngelicSmgThrow : ModProjectile {
		...
		public override string Texture => ModUtils.GetTheSameTextureAsEntity<AngelicSmg>();
		public override void SetStaticDefaults() {
