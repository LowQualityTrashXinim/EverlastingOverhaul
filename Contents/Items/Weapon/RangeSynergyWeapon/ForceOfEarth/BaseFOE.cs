...
namespace EverlastingOverhaul.Contents.Items.Weapon.RangeSynergyWeapon.ForceOfEarth {
	abstract class BaseFOE : ModProjectile {
		...
		public override void AI() {
			...
			if (Main.mouseRight && !player.mouseInterface && !player.GetModPlayer<ModUtilsPlayer>().CurrentHoveringOverChest) {
