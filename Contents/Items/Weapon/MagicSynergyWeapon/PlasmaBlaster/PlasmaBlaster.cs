...
namespace EverlastingOverhaul.Contents.Items.Weapon.MagicSynergyWeapon.PlasmaBlaster;

internal class PlasmaBlaster : ModItem {
	public override void SetDefaults() {
		Item.BossRushSetDefault(42, 24, 60, 4f, 30, 30, ItemUseStyleID.Shoot, false);
		ModUtils.BossRushDefaultMagic(Item, ModContent.ProjectileType<PlasmaBlasterLaserProjectile>(), 1f, 3);
