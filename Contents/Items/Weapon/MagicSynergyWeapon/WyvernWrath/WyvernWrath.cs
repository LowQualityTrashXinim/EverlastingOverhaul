...
namespace EverlastingOverhaul.Contents.Items.Weapon.MagicSynergyWeapon.WyvernWrath;
...
public class WyvernWrathMainProjectile : ModProjectile {
	...
	public override string Texture => ModUtils.GetVanillaTexture<Projectile>(ProjectileID.SkyFracture);
	...
	public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
		...
		for (int l = 0; l < 20; l++) {
			...
			float randomrotate = MathHelper.Lerp(50f, 1f, ModUtils.InOutSine(multiplier));
